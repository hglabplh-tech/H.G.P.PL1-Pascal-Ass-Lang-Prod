...
public class ProcedureBlock extends BlockClassBase implements Serializable, AutoCloseable {
    public ProcedureBlock(Token token, boolean openBlock, String name) {
        super(token, openBlock, name);
    }

    public File writeMeToStream() throws IOException {
        File tempFile = File.createTempFile("ProcedureBlock", ".obj");
