...
import hgp.lang.genCompile.expressions.ExpressionsToObjects;
...
public class PlPasAssLangListener extends pl_pas_assBaseListener
    ...
    public void enterConstantDefinition(pl_pas_assParser.ConstantDefinitionContext ctx) {
        ...
        if (constantCtx != null) {
            ExpressionsToObjects.ValTypeResult result = ExpressionsToObjects.handleConstantCtx(constantCtx);
    ...
    public void enterTypeDefinition(pl_pas_assParser.TypeDefinitionContext ctx) {
        ...
        if (varTypeCtx != null) {
            ...
            if (structType != null) {
                ExpressionsToObjects.handleStructType(structType, typeName);
            }
            if (simpleType != null) {
                ExpressionsToObjects.ValTypeResult res = ExpressionsToObjects.handleSimpleType(simpleType, typeName);
    ...
    public void exitFunctionType(pl_pas_assParser.FunctionTypeContext ctx) {
        ...
        if (listCtx != null) {
            ...
            for (FormalParameterSectionContext sectionCtx : formalParmList) {
                ...
                ExpressionsToObjects.traceSectionCtx(sectionCtx);
                if (fun != null) {
    ...
    public void exitVariable(pl_pas_assParser.VariableContext ctx) {
        ExpressionsToObjects.workOnVarContext(ctx);
    }
    ...
    public void enterWhileStatement(pl_pas_assParser.WhileStatementContext ctx) {
        Token whileTok = ctx.WHILE().getSymbol();
    ...
    public void visitTerminal(TerminalNode terminalNode, String name) {

        Token tok = terminalNode.getSymbol();
        Terminals terminal = new Terminals(tok, name, tok.getText(), tok.getType(), tok.getLine()
        );
